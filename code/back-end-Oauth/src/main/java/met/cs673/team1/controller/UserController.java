...
import met.cs673.team1.security.CurrentUser;
...
public class UserController {
    ...
    public UserGetDto getCurrentUser(@CurrentUser UserPrincipal userPrincipal) {
        UserGetDto user = userService.findById(userPrincipal.getId());
